'''
Gets the bedtools fisher's test results for all TE subfamily-cCRE overlaps in a given directory.
Multiple test corrects using Bonferonni method.
Usage: python3 summarize_fishers_subfamily_cCRE_overlaps.py <input directory of subfamily-cCRE tests> <output file>
'''
...
with open(sys.argv[-1], 'w') as o:
	o.write('Cell/tissue\tcCRE-type\tSubfamily_number\tNum_overlaps\tLeft_padj\tRight_padj\t2tail_padj\tRatio\n')
