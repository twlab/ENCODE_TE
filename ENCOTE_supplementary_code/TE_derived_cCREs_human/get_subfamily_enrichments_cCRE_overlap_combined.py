...
Calculates subfamily log2 enrichments at element (count) and base pair levels.
	Feature: Removes separation of CTCF-bound/unbound cCREs (e.g. "dELS,CTCF-bound" and "dELS" are combined)
Print subfamily overlap numbers to standard output.
Usage: python3 get_subfamily_enrichments_cCRE_overlap_combined.py <TE rmsk bed file> <input overlap file> <output file>
'''
