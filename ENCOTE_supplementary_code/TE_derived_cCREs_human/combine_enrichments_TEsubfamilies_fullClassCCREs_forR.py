...
Usage: python3 combine_enrichments_TEsubfamilies_fullClassCCREs_forR.py <TE subfamily enrichment directory> <min number of overlaps required> <output file basename>
'''
...
for ccre in ccre_types:
	...
	with open(filename, 'w') as o:
		o.write('Subfamily\tCelltype\tcCRE\tEnrichment\n')
		for subfamily in include_subfamilies:
			for celltype in celltypes:
				key = subfamily + '/' + celltype + '/' + ccre
				o.write(subfamily + '\t' + celltype + '\t' + ccre + '\t' + di[key] + '\n')
